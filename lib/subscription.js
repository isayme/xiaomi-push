...
function subscribeTopic (regids, topic, category) {
  if (_.isArray(regids)) {
    regids = regids.join(',')
  }
...
function unsubscribeTopic (regids, topic, category) {
  if (_.isArray(regids)) {
    regids = regids.join(',')
  }
...
function subscribeTopicByAlias (aliases, topic, category) {
...
function unsubscribeTopicByAlias (aliases, topic, category) {
  if (_.isArray(aliases)) {
    aliases = aliases.join(',')
  }
